...
struct i2c_pads_info i2c_pad_info0dl = {
	.scl = {
...
struct i2c_pads_info i2c_pad_info1dl = {
	.scl = {
...
struct i2c_pads_info i2c_pad_info2dl = {
	.scl = {
...
iomux_v3_cfg_t const uart1_padsdl[] = {
...
iomux_v3_cfg_t const enet_pads_finaldl[] = {
...
iomux_v3_cfg_t const usdhc1_padsdl[] = {							/* eMMC */
...
iomux_v3_cfg_t const usdhc2_padsdl[] = {							/* SDCARD */
...
iomux_v3_cfg_t const usdhc3_padsdl[] = {							/* SDCARD */
...
iomux_v3_cfg_t const pcie_padsdl[] = {
...
iomux_v3_cfg_t const di0_padsdl[] = {
	MX6_PAD_DI0_DISP_CLK__IPU1_DI0_DISP_CLK,	/* DISP0_CLK */
	MX6_PAD_DI0_PIN2__IPU1_DI0_PIN02,		/* DISP0_HSYNC */
	MX6_PAD_DI0_PIN3__IPU1_DI0_PIN03,		/* DISP0_VSYNC */
};

iomux_v3_cfg_t const codec_padsdl[] = {
	MX6_PAD_GPIO_19__GPIO4_IO05,
};

void setup_codec_padsdl(void){
	imx_iomux_v3_setup_multiple_pads(codec_padsdl, ARRAY_SIZE(codec_padsdl));
}
...
void setup_enet_pads_finaldl(void){
	imx_iomux_v3_setup_multiple_pads(enet_pads_finaldl, ARRAY_SIZE(enet_pads_finaldl));
}
void setup_uart1_padsdl(void){
	imx_iomux_v3_setup_multiple_pads(uart1_padsdl, ARRAY_SIZE(uart1_padsdl));
}
void setup_usdhc3_padsdl(void){
	imx_iomux_v3_setup_multiple_pads(usdhc3_padsdl, ARRAY_SIZE(usdhc3_padsdl));
}
void setup_usdhc2_padsdl(void){
	imx_iomux_v3_setup_multiple_pads(usdhc2_padsdl, ARRAY_SIZE(usdhc2_padsdl));
}
void setup_usdhc1_padsdl (void){
	imx_iomux_v3_setup_multiple_pads(usdhc1_padsdl, ARRAY_SIZE(usdhc1_padsdl));
}
void setup_di0_padsdl(void) {
	imx_iomux_v3_setup_multiple_pads(di0_padsdl, ARRAY_SIZE(di0_padsdl));
}
void setup_i2c_paddl(void){
	setup_i2c(0, CONFIG_SYS_I2C_SPEED, 0x7f, &i2c_pad_info0dl);
	setup_i2c(1, CONFIG_SYS_I2C_SPEED, 0x7f, &i2c_pad_info1dl);
	setup_i2c(2, CONFIG_SYS_I2C_SPEED, 0x7f, &i2c_pad_info2dl);
}
