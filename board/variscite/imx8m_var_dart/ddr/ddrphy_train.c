...
void ddr_cfg_phy(void) {
	...
	reg32_write(0x30360068,0x18ace02);
	...
	reg32_write(0x3c15000c,0x536);
	reg32_write(0x3c150020,0x121f);
	reg32_write(0x3c150064,0x12a4);
	...
	reg32_write(0x3c1500c8,0xa400);
	reg32_write(0x3c1500cc,0x3112);
	reg32_write(0x3c1500d0,0x4600);
	reg32_write(0x3c1500d4,0x84d);
	reg32_write(0x3c1500d8,0x4d);
	reg32_write(0x3c1500dc,0x1500);
	reg32_write(0x3c1500e0,0xa400);
	reg32_write(0x3c1500e4,0x3112);
