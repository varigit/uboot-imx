...
void ddr_init(void)
{
	...
	reg32_write(0x3d4000e0,0x330008);
	...
	reg32_write(0x3d402020,0x202);
	reg32_write(0x3d402024,0xec78f4b5);
	reg32_write(0x3d402050,0x618040);
	reg32_write(0x3d402064,0x610090);
	reg32_write(0x3d4020dc,0x140009);
	reg32_write(0x3d4020e0,0x310008);
	reg32_write(0x3d4020e8,0x46004a);
	reg32_write(0x3d4020ec,0x15004a);
	reg32_write(0x3d402100,0xb070a07);
	reg32_write(0x3d402104,0x3040a);
	reg32_write(0x3d402108,0x305080c);
	reg32_write(0x3d40210c,0x505000);
	reg32_write(0x3d402110,0x3040203);
	reg32_write(0x3d402114,0x2030303);
	reg32_write(0x3d402118,0x2020004);
	reg32_write(0x3d40211c,0x302);
	reg32_write(0x3d402130,0x20310);
	reg32_write(0x3d402134,0xa100002);
	reg32_write(0x3d402138,0x20);
	reg32_write(0x3d402144,0x220011);
	reg32_write(0x3d402180,0xa70005);
	reg32_write(0x3d402190,0x3858202);
	reg32_write(0x3d402194,0x404);
	reg32_write(0x3d4021b4,0x502);
	reg32_write(0x3d400240,0xb060908);
	reg32_write(0x3d400244,0x0);
	reg32_write(0x3d400250,0x29511505);
