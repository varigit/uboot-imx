...
static struct imx8_clks imx8qm_clks[] = {
	...
	CLK_4( IMX8QM_I2C4_DIV, "I2C4_DIV", SC_R_I2C_4, SC_PM_CLK_PER ),
...
static struct imx8_lpcg_clks imx8qm_lpcg_clks[] = {
	...
	CLK_5( IMX8QM_I2C4_CLK, "I2C4_CLK", 0, LPI2C_4_LPCG, IMX8QM_I2C4_DIV ),
	CLK_5( IMX8QM_I2C4_IPG_CLK, "I2C4_IPG", 16, LPI2C_4_LPCG, IMX8QM_IPG_DMA_CLK_ROOT ),
