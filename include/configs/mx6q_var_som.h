 ...
 *
 * Configuration settings for the MX6Q Variscite SOM.
 *
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs_nand=setenv bootargs ${bootargs} ubi.mtd=2 "     \
		"root=ubi0:rootfs rootfstype=ubifs\0"                \
		"bootcmd_nand=run bootargs_base bootargs_nand; "   \
		"nand read ${loadaddr} 0x200000 0x600000 ;bootm\0"  \
...
#define CONFIG_SYS_PROMPT		"MX6Q VAR_SOM U-Boot > "
...
#define CONFIG_FEC0_PHY_ADDR		0x7
...
/* #define PHYS_SDRAM_4GB		1	/* Un comment if you have 4GB DRAM Live the 2GB opend in 4GB !*/
#ifndef PHYS_SDRAM_2GB
#define PHYS_SDRAM_1_SIZE	(1u * 1024 * 1024 * 1024)
#else
#ifndef PHYS_SDRAM_4GB
#define PHYS_SDRAM_1_SIZE	(2u * 1024 * 1024 * 1024)
#else
#define PHYS_SDRAM_1_SIZE	(7u * 512 * 1024 * 1024) 
#endif
#endif
...
#define CONFIG_ENV_HALF_SECT_SIZE   (256 * 1024)
#define CONFIG_ENV_SIZE         CONFIG_ENV_SECT_SIZE
	...
	#undef  CONFIG_ENV_SIZE
        #define CONFIG_ENV_SIZE         CONFIG_ENV_HALF_SECT_SIZE
...
#define CONFIG_VARISCITE_TOUCHSCREEN_AUTO_DETECT
