...
#ifndef MX6Q_VAR_SOM_NAND_ANDROID_H
#define MX6Q_VAR_SOM_NAND_ANDROID_H

#include "mx6_var_som_nand.h"
...
#define CONFIG_FASTBOOT_PRODUCT_NAME_STR "VAR-SOM-MX6 Device"
...
#define CONFIG_FASTBOOT_TRANSFER_BUF_SIZE 0x17000000 /* 320M byte */
