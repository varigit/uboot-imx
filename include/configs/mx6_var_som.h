...
#ifndef __MX6_VAR_SOM_CONFIG_H
#define __MX6_VAR_SOM_CONFIG_H
...
#define CONFIG_PCIE_IMX_PERST_GPIO	IMX_GPIO_NR(5, 13)
#define CONFIG_PCIE_IMX_POWER_GPIO	IMX_GPIO_NR(2, 12)
#endif
