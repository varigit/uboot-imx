...
#ifndef __MX6UL_VAR_DART_ANDROID_H
#define __MX6UL_VAR_DART_ANDROID_H
...
#define HW_ENV_SETTINGS \
	"hwargs=setenv bootargs ${bootargs} som_rev=${som_rev};\0"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=" \
		...
		"androidboot.hardware=var-dart-6ul " \
		"consoleblank=0 " \
...
#endif	/* __MX6UL_VAR_DART_ANDROID_H */
